...
state_write() {
    cat > "${STATE_FILE}" <<EOF
WATCHDOG_FLOW_ID="${WATCHDOG_FLOW_ID:-}"
WATCHDOG_PHASE="${WATCHDOG_PHASE:-idle}"
...
WATCHDOG_LAST_REMOTE_PHASE="${WATCHDOG_LAST_REMOTE_PHASE:-}"
WATCHDOG_LAST_FAILURE_SUMMARY="${WATCHDOG_LAST_FAILURE_SUMMARY:-}"
...
WATCHDOG_REPAIR_COUNT="${WATCHDOG_REPAIR_COUNT:-0}"
